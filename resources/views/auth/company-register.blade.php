 ...
 @section('content')
     <div class="flex flex-col items-center justify-center my-8 p-12 w-11/12 max-w-2xl mx-auto bg-white rounded-md shadow-lg">
         ...
         <form method="POST" action="{{url('register/company')}}" class="w-full grid gap-4" novalidate>
             @csrf
             ...
             <div class="input-group grid gap-3">
                 ...
                 <x-text-input id="registration_code" type="text" name="registration_code" :value="old('registration_code')" required
